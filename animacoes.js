...
function moreAbout() {
  var html = `<div id='aboutMePart' class='about'> 
    ...
    <button class='moreAbout' onclick='moreAbout2()'>
    ABOUT ME <i class='bi bi-caret-right-fill'></i>
    </button>
  </div>`;

  $("#aboutMePart").html(html);
}
  ...
  var html = `
    ...
    <div id="contentProjects">
      <div class="boxProjects">
        ...
        <a onclick="explorarD()" class="link">PREVIEW </a>
    ...
    <div id="contentProjectsPython">
      <div class="boxProjectsPython">
        ...
        <a onclick="explorarP()" class="link">PREVIEW</a>
        <div class="iconesProject">
          <a
            class="icon"
            target="_blank"
    ...
    <div id="contentProjectsWeb">
      <div class="boxProjectsWeb">
        ...
        <a onclick="explorarW()" class="link">PREVIEW </a>
        <div class="iconesProject">
          <a
            class="icon"
            target="_blank"
